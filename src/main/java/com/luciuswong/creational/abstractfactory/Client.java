...
import com.luciuswong.creational.abstractfactory.aws.AwsResourceFactory;
import com.luciuswong.creational.abstractfactory.gcp.GoogleResourceFactory;
...
public class Client {
    ...
    public Instance createServer(Instance.Capacity capacity, int storageMib) {
        ...
        instance.attachStorage(factory.createStorage(storageMib));
        return instance;
    }
