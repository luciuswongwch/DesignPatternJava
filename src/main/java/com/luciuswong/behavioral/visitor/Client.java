...
public class Client {
	public static void main(String[] args) {
		...
		// for (Map.Entry<Integer, PerformanceRating> entry : visitor.getFinalRatings().entrySet()) {
		// 	System.out.println("Employee id: " + entry.getKey() + ", work performance: " + entry.getValue().getFinalRating());
		// }
	}
